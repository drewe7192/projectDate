...
struct CreateCardView_Previews: PreviewProvider {
    static var previews: some View {
        CreateCardView(card: MockService.cardsSampleData.first!,onRemove: {_ in}, swipeStatus: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$swipeStatus, question: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$question , answerA: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$answerA, answerB: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$answerB, answerC: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$answerC , categoryType: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$categoryType, profileType: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays")).$profileType )
    }
}
