...
struct CreateCardView_Previews: PreviewProvider {
    static var previews: some View {
        CreateCardView(card: MockService.cardsSampleData.first!,onRemove: {_ in}, swipeStatus: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$swipeStatus, question: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$question , answerA: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$answerA, answerB: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$answerB, answerC: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$answerC , categoryType: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$categoryType, profileType: CreateCardsView(showCardCreatedAlert: .constant(true),userProfile: ProfileModel(id: "fj8fsnfuh439", fullName: "dotZe30", location: "Tampa,Fl", gender: "Male", matchDay: "Mondays", messageThreadIds: [], speedDateIds: [], fcmTokens: [])).$profileType )
    }
}
