                ...
                .onAppear{
                    viewModel.getUserProfile(){(profileId) -> Void in
                        if profileId != "" {
                            ...
                            viewModel.getMatchRecordsForThisWeek() {(matchRecords) -> Void in
                                if !matchRecords.isEmpty {
                                    viewModel.getProfiles(matchRecords: matchRecords) {(matchProfiles) -> Void in
                                    ...
                                    viewModel.updateMatchRecords(matchRecords: matchRecords)
                                }
                            }
                        }
                    }
